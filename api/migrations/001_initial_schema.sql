...
CREATE TABLE users (
    ...
    package_name VARCHAR(50) NOT NULL DEFAULT 'default',
    role VARCHAR(20) NOT NULL DEFAULT 'user' CHECK (role IN ('admin', 'user', 'reseller')),

    -- Quotas and limits
    disk_quota BIGINT NOT NULL DEFAULT 0, -- MB, 0 = unlimited
    bandwidth_quota BIGINT NOT NULL DEFAULT 0, -- MB, 0 = unlimited
    web_domains_limit INTEGER NOT NULL DEFAULT 0, -- 0 = unlimited
    dns_domains_limit INTEGER NOT NULL DEFAULT 0,
    mail_domains_limit INTEGER NOT NULL DEFAULT 0,
    databases_limit INTEGER NOT NULL DEFAULT 0,
    cron_jobs_limit INTEGER NOT NULL DEFAULT 0,

    -- Usage counters
    disk_used BIGINT NOT NULL DEFAULT 0,
    bandwidth_used BIGINT NOT NULL DEFAULT 0,
    web_domains_count INTEGER NOT NULL DEFAULT 0,
    dns_domains_count INTEGER NOT NULL DEFAULT 0,
    mail_domains_count INTEGER NOT NULL DEFAULT 0,
    ...
    suspended_web BOOLEAN NOT NULL DEFAULT FALSE,
    suspended_dns BOOLEAN NOT NULL DEFAULT FALSE,
    suspended_mail BOOLEAN NOT NULL DEFAULT FALSE,
    suspended_db BOOLEAN NOT NULL DEFAULT FALSE,
    suspended_cron BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE web_domains (
    ...
    backend_template VARCHAR(50) NOT NULL DEFAULT 'default',
    ...
    ssl_force BOOLEAN NOT NULL DEFAULT FALSE,
    ssl_hsts BOOLEAN NOT NULL DEFAULT FALSE,
    letsencrypt_enabled BOOLEAN NOT NULL DEFAULT FALSE,
    letsencrypt_wildcard BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE dns_zones (
    ...
    expire_interval INTEGER NOT NULL DEFAULT 1209600,
    minimum_ttl INTEGER NOT NULL DEFAULT 86400,

    -- DNS provider and settings
    dns_provider VARCHAR(50) NOT NULL DEFAULT 'local', -- local, cloudflare, powerdns, route53
    provider_zone_id VARCHAR(255),
    dnssec_enabled BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE TABLE dns_records (
    ...
    priority INTEGER NOT NULL DEFAULT 0, -- for MX, SRV records
...
CREATE TABLE mail_domains (
    ...
    -- Rate limiting
    rate_limit INTEGER NOT NULL DEFAULT 100, -- emails per hour
...
CREATE TABLE mail_accounts (
    ...
    -- Full address (username@domain); populated by the application at creation time.
    -- Postgres generated columns cannot reference other tables, so this is set explicitly.
...
CREATE TABLE databases (
    ...
    type VARCHAR(20) NOT NULL DEFAULT 'postgresql' CHECK (type IN ('postgresql', 'mysql', 'mariadb')),
...
CREATE TABLE database_users (
    ...
    -- Permissions
    permissions JSONB NOT NULL DEFAULT '["SELECT", "INSERT", "UPDATE", "DELETE"]',
...
CREATE TABLE cron_jobs (
    ...
    log_output BOOLEAN NOT NULL DEFAULT TRUE,
    email_output BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE backup_configs (
    ...
    retention_policy JSONB NOT NULL DEFAULT '{"daily": 7, "weekly": 4, "monthly": 6, "yearly": 2}',
